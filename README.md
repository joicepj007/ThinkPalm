...
It's a simple Movie list application in which the users can see the movies list.
And MVVM architecture pattern is used.
...
- MVVM,Coroutines,Moshi,LiveData,Viewmodel,Picasso,Lifecycle,Recyclerview,Cardview etc